...
// ex (Windows): C:\Users\usuario\AppData\Local\Temp\NutriCare-views
const TEMP_DIR = path.join(app.getPath('temp'), 'NutriCare-views');
...
// Pode ser exibido em qualquer template assim: {{ appName }} → "NutriCare"
nunjucksEnv.addGlobal('appName', 'NutriCare');
